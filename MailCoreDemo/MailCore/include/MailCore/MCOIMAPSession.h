...
/**When set to YES, CapabilityId will be enabled on the IMAP connection on iOS, Default is YES */
@property (nonatomic, assign, getter=isCapabilityId) BOOL capabilityIdEnabled;
